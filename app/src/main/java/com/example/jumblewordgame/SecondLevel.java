...
public class SecondLevel extends AppCompatActivity {
    ...
    private String []cityName={"Mango","Apple","Grape","Banana","Pineapple","Orange","Watermelon","Cherry","Strawberry","pomegranate"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean isNext=  preferences.getBoolean("secondLevel",false);
                                        ...
                                        ("submit"))
                                {
                                    ...
                                    submit.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            editor.putBoolean("secondLevel",false).apply();
                                            startActivity(new Intent(SecondLevel.this,SecondLevel.class));
                                            finish();
                                        }
                                    });
                                    ...
                                    nextGame.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            SharedPreferences.Editor editor=preferences.edit();
                                            editor.putBoolean("secondLevel",true).apply();
