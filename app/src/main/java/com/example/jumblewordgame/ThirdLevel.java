...
public class ThirdLevel extends AppCompatActivity {
    ...
    private String []cityName={"Porcupine","Raccoon","Chipmunk","Wombat","Hippopotamus","Rhinoceros","Chimpanzee","jaguar","jackal","Hyena"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final boolean isNext=  preferences.getBoolean("thirdLevel",false);
                                        ...
                                        ("submit"))
                                {
                                    ...
                                    submit.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            editor.putBoolean("thirdLevel",false).apply();
                                            startActivity(new Intent(ThirdLevel.this,ThirdLevel.class));
                                            finish();
                                        }
                                    });
                                    ...
                                    nextGame.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            SharedPreferences.Editor editor=preferences.edit();
                                            editor.putBoolean("thirdLevel",true).apply();
                                            startActivity(new Intent(ThirdLevel.this,FouthLevel.class));
                                            finish();
