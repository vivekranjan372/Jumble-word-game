...
public class FouthLevel extends AppCompatActivity {
    ...
    private String []cityName={"Sawasadan","Karmbhumi","Nirmla","karyakalaap","Kafan","Ahankar","Vardaan","Godaan","Pratigya","Gaban"};
    private String[]jumbleArray=new String[cityName.length];
    private SharedPreferences preferences;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fouth_level);
        ...
        final boolean isNext=  preferences.getBoolean("fourthLevel",false);
                                        ...
                                        ("submit"))
                                {
                                    ...
                                    submit.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            editor.putBoolean("fourthLevel",false).apply();
                                            startActivity(new Intent(FouthLevel.this,FouthLevel.class));
                                            finish();
                                        }
                                    });
                                    ...
                                    nextGame.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            SharedPreferences.Editor editor=preferences.edit();
                                            editor.putBoolean("fourthLevel",true).apply();
                                            startActivity(new Intent(FouthLevel.this,FifthLevel.class));
                                            finish();
